	...
	<div class="row justify-content-center g-4">
		...
		<div class="col-md-6 col-lg-3">
			<div class="four_cards__card">
				<div class="four_cards__lead has-pink-400-color"><?= esc_html( get_field( 'lead_1' ) ); ?></div>
		...
		<div class="col-md-6 col-lg-3">
			<div class="four_cards__card">
				<div class="four_cards__lead has-pink-400-color"><?= esc_html( get_field( 'lead_2' ) ); ?></div>
		...
		<div class="col-md-6 col-lg-3">
			<div class="four_cards__card">
				<div class="four_cards__lead has-pink-400-color"><?= esc_html( get_field( 'lead_3' ) ); ?></div>
		...
		<div class="col-md-6 col-lg-3">
			<div class="four_cards__card">
				<div class="four_cards__lead has-pink-400-color"><?= esc_html( get_field( 'lead_4' ) ); ?></div>
